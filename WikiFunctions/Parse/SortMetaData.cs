...
namespace WikiFunctions.Parse
{
    ...
    public partial class Parsers
    {
        ...
        public string SortMetaData(string articleText, string articleTitle, bool fixOptionalWhitespace)
        {
            ...
            return (Variables.Project <= ProjectEnum.species || Variables.Project == ProjectEnum.commons) ? Sorter.Sort(articleText, articleTitle, fixOptionalWhitespace) : articleText;
        }
