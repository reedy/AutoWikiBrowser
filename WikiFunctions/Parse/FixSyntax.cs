...
namespace WikiFunctions.Parse
{
    ...
    public partial class Parsers
    {
        ...
        private static readonly Regex IncorrectBr3 = new Regex(@"<br\s*style\s*=\s*""clear\:\s?(both|left|right)\;?""(\s*clear=\s*""(all|left|right)"")?\s*/?>", RegexOptions.IgnoreCase | RegexOptions.Compiled);
