...
namespace WikiFunctions.Parse
{
    ...
    public partial class Parsers
    {
        ...
        private static readonly Regex IdISSN = new Regex(@"^ISSN:?\s*([0-9]{4}) *[- ]? *([0-9]{4})$", RegexOptions.IgnoreCase);
