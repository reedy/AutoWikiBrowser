...
namespace WikiFunctions.Parse
{
    ...
    public class Parsers
    {
        ...
        private static readonly Regex NotPersonArticles = new Regex(@"(^(((?:First )?(?:Premiership|Presidency)|List|Murder|Disappearance|Suicide|Adoption) of|Deaths|[12]\d{3}\b|\d{2,} )|(discography|filmography| deaths| murders)$)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
