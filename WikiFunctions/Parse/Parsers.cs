...
namespace WikiFunctions.Parse
{
    ...
    public class Parsers
    {
        ...
        private static readonly Regex citeWebParameters = new Regex(@"\b(accessdate|agency|archivedate|archiveurl|arxiv|asin|at|author\d?|authorlink\d?|authors?|author-mask|author-name-separator|author-separator|bibcode|chapter|chapter\-?url|coauthors?|contribution|date|deadurl|display-authors|doi|doibroken|edition|editors?|editor\d*-first|editor\d*-last|editor\d*-link|first\d*|format|id|isbn|issue|issn|jfm|journal|jstor|language|last\d*|lastauthoramp|laydate|laysource|layrul|lccn|location|magazine|month|mr|newspaper|oclc|ol|origyear|others|osti|pages?|periodical|place|pmc|pmid|postscript|publisher|quote|ref|registration|rfc|section|sectionurl|separator|series|subscription|ssrn|title|trans_title|type|url|via|volume|website|work|year|zbl|article|entry|website|encyclopa?edia|dictionary|entry|distributor|institution|version|laysummary|contribution\-?url|publication\-?(?:place|date))\b", RegexOptions.Compiled);
