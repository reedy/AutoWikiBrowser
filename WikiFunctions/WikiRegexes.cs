...
";
        ...
        public static readonly Regex DeletionProtectionTags = new Regex(Tools.NestedTemplateRegex(new [] { "Bne", "Cc-by-nc-2.0", "Cc-by-nc-sa", "Cc-by-nc-sa-2.0", "Cc-nc", "D", "DB", "DELETE", "Db", "Db doc", "Db-Reason", "Db-a1", "Db-a10", "Db-a11", "Db-a2", "Db-a3", "Db-a4", "Db-a5", "Db-a6", "Db-a7", "Db-a9", "Db-ad", "Db-advert", "Db-advertising", "Db-album", "Db-animal", "Db-attack", "Db-author", "Db-band", "Db-banned", "Db-because", "Db-bio", "Db-bio-notenglish", "Db-biography", "Db-blank", 
            ...
            "Prod blp/dated", "Proposed deletion/dated", "Transwiki/dated", "Article for deletion/dated", "Article for deletion"}).ToString() + @"(?: *<!--[^<>\r\n]+-->)?");
