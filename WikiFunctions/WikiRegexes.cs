...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        public const string ReferencesTemplates = @"(\{\{\s*(?:[Rr]ef(?:-?li(?:st|nk)|erence)|[Ll]istaref|[Ll]ist of botanists by author abbreviation footer|[Aa]irline codes page/bottom|[Ss]COTUS-justice-listframe|[Mm]inorPlanetNameMeaningsFooter00)(?>[^\{\}]+|\{(?<DEPTH>)|\}(?<-DEPTH>))*(?(DEPTH)(?!))\}\}|<\s*[Rr]eferences\s*/>|\{\{refs|<\s*references\s*>.*</\s*references\s*>)";
