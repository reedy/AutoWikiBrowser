...
";
        ...
        /// </summary>
        public static readonly Regex MaintenanceTemplates = Tools.NestedTemplateRegex(new[] { "orphan", "BLP unsourced", "BLP sources", "cleanup", "underlinked", "dead end", "notability", "one source", "refimprove", "unreferenced" }, false );
