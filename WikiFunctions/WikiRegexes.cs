...
";
        ...
        /// </summary>
        public static readonly Regex MultipleIssuesArticleMaintenanceTemplates = Tools.NestedTemplateRegex(new [] { "Abbreviations", "Advert", "All plot", "Alumni", "Autobiography", "Biblio", "BLP IMDb refimprove", "BLP primary sources", "BLP sources", "BLP unreferenced", "BLP unsourced", "Buzzword", "Citations broken", "Citation style", "Cite check", "Cleanup", "Cleanup bare URLs", "Cleanup-bare URLs", "Cleanup biography", "Cleanup-biography", "Cleanup-laundry", "Cleanup list", "Cleanup-list", "Cleanup-PR", "Cleanup red links", "Cleanup reorganize", "Cleanup-reorganize", "Cleanup rewrite", "Cleanup-rewrite", "Cleanup school", "Cleanup-school", "Cleanup-spam", "Cleanup tense", "Cleanup-tense", "COI", "Colloquial", "Condense", "Confusing", "Context", "Contradict", "Contradict-other", "Contradicts other", "Copy edit", "Criticism section", "Crystal", "Dead end", "Disputed", "Editorial", "Essay", "Essay-like", "Example farm", "Excessive examples", "Expand article", "Expert needed", "Expert-subject", "External links", "Fanpov", "Fiction", "Format footnotes", "Game guide", "Generalize", "Globalize", "Globalize/North America", "Globalize/US", "Historical information needed", "Hoax", "How-to", "Howto", "Improve lead", "Inadequate lead", "Inappropriate person", "Incoherent", "Incomplete", "In-universe", "Lead missing", "Lead rewrite", "Lead too long", "Lead too short", "Like resume", "Local", "Localist", "Long plot", "Magazine", "Manual", "Medref", "Missing information", "More citations needed", "More footnotes", "More footnotes needed", "More medical citations needed", "MOS", "MOSLOW", "Neologism", "News release", "No footnotes", "Non-free", "Notability", "NPOV language", "Obituary", "One source", "Original research", "Orphan", "Out of date", "Over coverage", "Over-coverage", "Overlinked", "Overly detailed", "Over-quotation", "Page numbers needed", "Peacock", "Plot", "POV", "POV-check", "Primary sources", "Prose", "Prune", "Recentism", "Refimprove", "Religious text primary", "Repetition", "Review", "Sections", "Self-contradictory", "Self-published", "Sources exist", "Speculation", "Story", "Synthesis", "Technical", "Third-party", "Tone", "Too few opinions", "Too many sections", "Travel guide", "Trivia", "Unbalanced", "Underlinked", "Undue", "Undue weight", "Unfocused", "Unreferenced", "Unreliable sources", "Update", "USgovtPOV", "Very long", "Video game cleanup", "Weasel", "Wikify",
