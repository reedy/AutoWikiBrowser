...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        public static void MakeLangSpecificRegexes()
        {
            ...
            switch(Variables.LangCode)
            {
                ...
                case "ru":
                    ...
                    break;
                default:
                    Orphan = new Regex(@"(?:{{\s*[Oo]rphan(?:\|(?:[^{}]+|date={{subst:CURRENTMONTHNAME}} {{subst:CURRENTYEAR}}))?}}|(?<MI>{{\s*(?:[Aa]rticle|[Mm]ultiple)\s*issues\b[^{}]*?(?:{{subst:CURRENTMONTHNAME}} {{subst:CURRENTYEAR}})?[^{}]*?)*\|\s*orphan\s*=\s*(?:{{subst:CURRENTMONTHNAME}} {{subst:CURRENTYEAR}}|[^{}\|]+))", RegexOptions.Compiled);
                    uncattemplate = UncatTemplatesEN;
                    DateYearMonthParameter = @"date={{subst:CURRENTMONTHNAME}} {{subst:CURRENTYEAR}}";
        ...
        /// </summary>
        public static readonly Regex CiteTemplate = Tools.NestedTemplateRegex(new [] { "cite web", "citeweb", "cite news", "cite journal", "cite book", "citebook", "citation", "cite press release", "cite paper", "cite hansard", "cite encyclopedia" }, false);
...
";
        ...
        public static readonly Regex PeopleInfoboxTemplates = Tools.NestedTemplateRegex(new [] { "Infobox college coach", "Infobox American Indian chief", "Infobox Calvinist theologian", "Infobox Chinese-language singer and actor",
                                                                                            ...
                                                                                            "Infobox ice hockey player", "Infobox motorcycle rider", "Infobox rugby biography", "Infobox rugby league biography", "Infobox Rugby Union biography", "Infobox rugby union biography" }, false);
        ...
        /// </summary>
        public static readonly Regex ClockTimeWithZero = new Regex(@"0(\d\:\b[012345]\d)([a|p].m.)", RegexOptions.Compiled);
        public static readonly Regex ClockTime = new Regex(@"(\b[1]?\d\:\b[012345]\d)([a|p].m.)", RegexOptions.Compiled);
