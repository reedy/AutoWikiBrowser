...
";
        ...
        /// </summary>
        public static readonly Regex MultipleIssuesArticleMaintenanceTemplates = Tools.NestedTemplateRegex(new [] { "Abbreviations", "Advert", "All plot", "Alumni", "Autobiography", "Biblio", "BLP IMDb refimprove", "BLP primary sources", "BLP sources", "BLP unreferenced", "BLP unsourced", "Buzzword", "Citations broken", "Citation style", "Cite check", "Cleanup", "Cleanup bare URLs", "Cleanup-bare URLs", "Cleanup biography", "Cleanup-biography", "Cleanup-laundry", "Cleanup list", "Cleanup-list", "Cleanup-PR", "Cleanup red links", "Cleanup reorganize", "Cleanup-reorganize", "Cleanup rewrite", "Cleanup-rewrite", "Cleanup school", "Cleanup-school", "Cleanup-spam", "Cleanup tense", "Cleanup-tense", "COI", "Colloquial", "Condense", "Confusing", "Context", "Contradict", "Contradict-other", "Contradicts other", "Copy edit", "Criticism section", "Crystal", "Dead end", "Disputed", "Editorial", "Essay", "Essay-like", "Example farm", "Excessive examples", "Expand article", "Expert needed", "Expert-subject", "External links", "Fanpov", "Fiction", "Format footnotes", "Game guide", "Generalize", "Globalize", "Hoax", "How-to", "Howto", "Improve lead", "Inadequate lead", "Inappropriate person", "Incoherent", "Incomplete", "In-universe", "Lead missing", "Lead rewrite", "Lead too long", "Lead too short", "Like resume", "Local", "Localist", "Long plot", "Magazine", "Manual", "Medref", "Missing information", "More citations needed", "More footnotes", "More footnotes needed", "More medical citations needed", "MOS", "MOSLOW", "Neologism", "News release", "No footnotes", "Non-free", "Notability", "NPOV language", "Obituary", "One source", "Original research", "Orphan", "Out of date", "Over coverage", "Over-coverage", "Overlinked", "Overly detailed", "Over-quotation", "Page numbers needed", "Peacock", "Plot", "POV", "POV-check", "Primary sources", "Prose", "Prune", "Recentism", "Refimprove", "Religious text primary", "Repetition", "Review", "Sections", "Self-contradictory", "Self-published", "Sources exist", "Speculation", "Story", "Synthesis", "Technical", "Third-party", "Tone", "Too few opinions", "Too many sections", "Travel guide", "Trivia", "Unbalanced", "Underlinked", "Undue", "Undue weight", "Unfocused", "Unreferenced", "Unreliable sources", "Update", "USgovtPOV", "Very long", "Weasel", "Wikify",
            "Expand Afrikaans", "Expand Albanian", "Expand Amharic", "Expand Arabic", "Expand Aragonese", "Expand Armenian", "Expand Assamese", "Expand Asturian", "Expand Azerbaijani", "Expand Basque", "Expand Bavarian", "Expand Belarusian", "Expand Belarusian (Taraškievica)", "Expand Bengali", "Expand Bishnupriya Manipuri", "Expand Bosnian", "Expand Breton", "Expand Bulgarian", "Expand Burmese", "Expand Cantonese", "Expand Catalan", "Expand Cebuano", "Expand Central Bikol", "Expand Central Kurdish", "Expand Chewa", "Expand Chinese", "Expand Colognian", "Expand Corsican", "Expand Crimean Tatar", "Expand Croatian", "Expand Czech", "Expand Danish", "Expand Dutch", "Expand Dutch Low Saxon", "Expand Egyptian Arabic", "Expand Emiliano-Romagnolo", "Expand Esperanto", "Expand Estonian", "Expand Ewe", "Expand Faroese", "Expand Finnish", "Expand French", "Expand Friulian", "Expand Galician", "Expand Georgian", "Expand German", "Expand Greek", "Expand Gujarati", "Expand Haitian Creole", "Expand Hausa", "Expand Hawaiian", "Expand Hebrew", "Expand Hindi", "Expand Hungarian", "Expand Icelandic", "Expand Ido", "Expand Igbo", "Expand Indonesian", "Expand Irish", "Expand Italian", "Expand Japanese", "Expand Javanese", "Expand Kannada", "Expand Kazakh", "Expand Khmer", "Expand Korean", "Expand Kurdish", "Expand Kyrgyz", "Expand language", "Expand Lao", "Expand Latin", "Expand Latvian", "Expand Lezgian", "Expand Limburgish", "Expand Lithuanian", "Expand Lojban", "Expand Lombard", "Expand Luxembourgish", "Expand Macedonian", "Expand Malagasy", "Expand Malay", "Expand Malayalam", "Expand Maltese", "Expand Maori", "Expand Marathi", "Expand Minangkabau", "Expand Mingrelian", "Expand Mongolian", "Expand Neapolitan", "Expand Nepali", "Expand North Frisian", "Expand Norwegian", "Expand Norwegian (Nynorsk)", "Expand Ossetian", "Expand Papiamento", "Expand Pashto", "Expand Persian", "Expand Polish", "Expand Portuguese", "Expand Punjabi", "Expand Quechua", "Expand Romanian", "Expand Russian", "Expand Samoan", "Expand Samogitian", "Expand Sanskrit", "Expand Sardinian", "Expand Saterland Frisian", "Expand Scots", "Expand Scottish Gaelic", "Expand Serbian", "Expand Serbo-Croatian", "Expand Shona", "Expand Sicilian", "Expand Sindhi", "Expand Sinhalese", "Expand Slovak", "Expand Slovenian", "Expand Somali", "Expand Sotho", "Expand Spanish", "Expand Sundanese", "Expand Swahili", "Expand Swedish", "Expand Tagalog", "Expand Tajik", "Expand Tamil", "Expand Tatar", "Expand Telugu", "Expand Testlish", "Expand Thai", "Expand Tibetan", "Expand Tongan", "Expand Tswana", "Expand Turkish", "Expand Ukrainian", "Expand Urdu", "Expand Uzbek", "Expand Vietnamese", "Expand Volapük", "Expand Võro", "Expand Walloon", "Expand Waray", "Expand warning", "Expand Welsh", "Expand Western Frisian", "Expand West Flemish", "Expand Xhosa", "Expand Yiddish", "Expand Yoruba", "Expand Zulu" } );
        ...
        /// </summary>
        public static readonly Regex Dablinks = Tools.NestedTemplateRegex(new [] { "about", "about2", "about-distinguish", "about-distinguish2", "ambiguous link", "for", "for2", "for-multi", "for multi", "dablink", "distinguish", "distinguish2", "distinguish-otheruses", "distinguish-otheruses2", "further", "further2", "hatnote", "otherpeople", "otherpeople1", "otherpeople2", "otherpeople3", 
                ...
                "otheruses2", "otheruses3", "otheruses4", "other uses of", "otheruse", "outline", "redirect-acronym", "redirect-distinguish", "redirect-distinguish-text", "redirect-distinguish2", "redirect-multi", "redirect-several", "redirect", "redirect2", "redirect3", "see also", "this", "disambig-acronym", "selfref" }, false);
        ...
        /// </summary>
        public static readonly Regex DeletionProtectionTags = new Regex(@"(?:<!--\s*[^<>\r\n]+\s*-->\s*)*" + Tools.NestedTemplateRegex(new [] { "Bne", "Cc-by-nc-2.0", "Cc-by-nc-sa", "Cc-by-nc-sa-2.0", "Cc-nc", "D", "DB", "DELETE", "Db", "Db doc", "Db-Reason", "Db-a1", "Db-a10", "Db-a11", "Db-a2", "Db-a3", "Db-a4", "Db-a5", "Db-a6", "Db-a7", "Db-a9", "Db-ad", "Db-advert", "Db-advertising", "Db-album", "Db-animal", "Db-attack", "Db-author", "Db-band", "Db-banned", "Db-because", "Db-bio", "Db-bio-notenglish", "Db-biography", "Db-blank", 
                "Db-blanked", "Db-blp", "Db-bn", "Db-bne", "Db-c1", "Db-cat-empty", "Db-ce", "Db-club", "Db-cm", "Db-comp", "Db-company", "Db-contact", "Db-content", "Db-context", "Db-copypaste", "Db-copyvio", "Db-corp", "Db-disambig", "Db-e", "Db-ec", "Db-empty", "Db-emptycat", "Db-error", "Db-event", "Db-f1", "Db-f10", "Db-f2", "Db-f3", "Db-f7", "Db-f9", "Db-fake", "Db-foreign", "Db-fpcfail", "Db-g1", "Db-g10", "Db-g11", "Db-g12", "Db-g13", "Db-g2", "Db-g3", "Db-g4", "Db-g5", "Db-g6", 
                "Db-g7", "Db-g8", "Db-gallery", "Db-gfdl", "Db-group", "Db-hoax", "Db-house", "Db-imagepage", "Db-imgcopyvio", "Db-inc", "Db-internet", "Db-intertubes", "Db-invented", "Db-madeup", "Db-maint", "Db-maintenance", "Db-meta", "Db-misrepresent", "Db-misrepresentation", "Db-move", "Db-movedab", "Db-mt", "Db-multiple", "Db-negublp", "Db-nn", "Db-nocontent", "Db-nocontext", "Db-noncom", "Db-noncommercial", "Db-nonsense", "Db-notenglish", "Db-notwebhost", "Db-org", "Db-owner", 
                "Db-p1", "Db-p2", "Db-pagemove", "Db-peo", "Db-people", "Db-person", "Db-promo", "Db-r1", "Db-r2", "Db-r3", "Db-redirect", "Db-redirmisnomer", "Db-redirnone", "Db-repost", "Db-self", "Db-site", "Db-song", "Db-spam", "Db-spamuser", "Db-subpage", "Db-t2", "Db-t3", "Db-talk", "Db-templatecat", "Db-test", "Db-transwiki", "Db-tw", "Db-u", "Db-u1", "Db-u2", "Db-u3", "Db-u5", "Db-user", "Db-userpage", "Db-vand", "Db-vandalism", "Db-web", "Db-webhost", "Db-website", "Db-xfd", 
                "Dbe", "Declinedsd", "Delbecause", "Delete", "Delete because", "Delete when empty", "DeleteVanity", "Deletebecause", "Deletevanity", "Duplicate", "Dv", "Empty", "Hang on", "Hangon click preload", "Hangon preload C1", "Nocontent", "Nocontext", "Notg4", "Oldcsd", "Oldcsdfull", "Salt", "Sdd", "Sdd2", "Sdd3", "Should be a user space test page please delete", "Speedy", "Speedy delete", "Speedy deletion templates", "Speedydelete", 
            "Db-speedy delete if article", "Speedy deletion-nonfree galleries", "Speedy deletion-foreign language", "Speedy deletion-technical", "Speedy deletion-no content", "Speedy deletion-unpopulated category", "Speedy deletion-vandalism", "Speedy deletion-blocked user", "Speedy deletion-duplicate template", "Speedy deletion-nonexistent user", "Speedy deletion-test page", "Speedy deletion-previously deleted", 
            "Speedy deletion-musical recording", "Speedy deletion-attack", "Speedy deletion-duplicate article", "Speedy deletion-no context", "Speedy deletion-nonsense", "Speedy deletion-advertising", "Speedy deletion-copyright violation", "Speedy deletion-author request", "Speedy deletion",
            "Book-prod", "BPRODNote", "BPRODWarning", "Dated book prod", "Deprod", "Deprod-afd", "Deprod-article", "Deprod-contro", "Deprod-disagree", "Deprod-m", "Deprod-reprod", "Old prod full", "Please prod", "Polite-prod", "Prod backlog", "Prod backlog inner", "Prod blp", "Prod contested", "Prod hint", "Prod NFC use", "Prod pending", "Prod subcategory starter", "Prod-nn", "Prod-reason", "Prod-speedy", "Prod-summary", "Prod-tip", "Prod2", "BLP prodded", "Prodded", "PRODNote",
