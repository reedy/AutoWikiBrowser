...
namespace WikiFunctions.TalkPages
{
    ...
    public static class TalkPageFixes
    {
        ...
        private static readonly Regex EnglishVariationsTemplates = Tools.NestedTemplateRegex(new[] { "American English", "Australian English", "Bangladeshi English", "Botswana English", "British English", "British English Oxford spelling", "Canadian English", "Commonwealth English", "Gambian English", "Ghanaian English", "Hiberno-English", "Hong Kong English", "Indian English", "Israeli English", "Jamaican English", "Kenyan English", "Liberian English", "Malaysian English", "Malawian English", "Namibian English", "New Zealand English", "Nigerian English", "Pakistani English", "Philippine English", "Scottish English", "Sierra Leonean English", "Singaporean English", "South African English", "Sudanese English", "Trinidadian English", "Ugandan English", "Zambian English" });
