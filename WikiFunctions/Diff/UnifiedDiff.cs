...
namespace WikiFunctions
{
    ...
    public class UnifiedDiff
    {
        ...
        public static void WriteUnifiedDiff(string leftFile, string rightFile, TextWriter writer, int context,
                                            bool caseSensitive, bool compareWhitespace)
        {
            WriteUnifiedDiff(LoadFileLines(leftFile), leftFile, LoadFileLines(rightFile), rightFile, writer, context,
                             caseSensitive, compareWhitespace);
        }
