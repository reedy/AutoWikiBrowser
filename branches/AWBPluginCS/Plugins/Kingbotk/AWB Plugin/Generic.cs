...
namespace AutoWikiBrowser.Plugins.Kingbotk.Plugins
{
	internal sealed partial class GenericTemplateSettings : IGenericSettings
	{
		...
		public void ReadXML(XmlTextReader Reader)
		{
			...
			ImportanceSetting = (ImportanceSettingEnum)ImportanceSettingEnum.Parse(typeof(ImportanceSettingEnum), PluginManager.XMLReadString(Reader, conTemplateImportanceParm, ImportanceSetting.ToString()), true);
	...
	internal sealed class GenericTemplatePlugin : PluginBase, IGenericTemplatePlugin
	{
		...
		{
			if (MessageBox.Show("Delete the " + OurName + " plugin?", "Delete?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes) {
