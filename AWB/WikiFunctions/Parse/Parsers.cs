...
namespace WikiFunctions.Parse
{
    ...
    public class Parsers
    {
        ...
        static Parsers()
        {
            ...
            RegexTagger.Add(new Regex(@"\{\{(template:)?\s*([Cc]n|[Ff]act|[Pp]roveit|[Cc]iteneeded|[Uu]ncited|[Cc]itation needed)\s*\}\}", RegexOptions.Compiled), "{{$2|date={{subst:CURRENTMONTHNAME}} {{subst:CURRENTYEAR}}}}");
