...
namespace WikiFunctions.Parse
{
    ...
    public class Parsers
    {
        ...
        private static readonly Regex citeWebParameters = new Regex(@"\b(accessdate|agency|archivedate|archiveurl|arxiv|asin|at|author\d?|authorlink\d?|authors|author-mask|author-name-separator|author-separator|bibcode|coauthors?|date|deadurl|display-authors|doi|doibroken|editor|editor\d*-first|editor\d*-last|editor\d*-link|first\d*|format|id|isbn|issn|jfm|jstor|language|last\d*|lastauthoramp|laydate|laysource|layrul|lccn|location|month|mr|oclc|ol|origyear|others|osti|pages?|pmc|pmid|postscript|publisher|quote|ref|registration|rfc|separator|series|subscription|ssrn|title|trans_title|type|url|via|website|work|year|zbl)\b", RegexOptions.Compiled);
