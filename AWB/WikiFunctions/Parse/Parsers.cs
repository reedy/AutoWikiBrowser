...
namespace WikiFunctions.Parse
{
    ...
    public class Parsers
    {
        ...
        private static readonly Regex citeWebParameters = new Regex(@"\b(first\d?|last\d?|author|authorlink\d?|coauthors?|title|url|archiveurl|work|publisher|location|pages?|language|trans_title|format|doi|date|month|year|archivedate|accessdate|quote|ref|separator|postscript|at|deadurl)\b", RegexOptions.Compiled);
