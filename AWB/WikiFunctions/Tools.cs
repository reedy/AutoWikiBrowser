...
namespace WikiFunctions
{
	...
	public static class Tools
	{
        ...
        public static readonly string[][] Diacritics =
		{
			...
			new [] {"е", "e"}, //cyrillic e (&#1077;)
			new [] {"Е", "E"}, //cyrillic E
			new [] {"і", "i"}, //cyrillic i (&#1110;)
			new [] {"І", "I"}, //cyrillic I
			new [] {"х", "x"}, //cyrillic x (&#1061;)
			new [] {"Х", "X"}, //cyrillic X
			...
			new [] {"ȵ", "n"},
			new [] {"ȶ", "t"},
			new [] {"ȿ", "s"}, // S with swash tail
			new [] {"ɀ", "z"}, // Z with swash tail
			new [] {"Ɖ", "D"}, // African D
			new [] {"ɖ", "d"}, // African D
			new [] {"Ƌ", "D"},
			new [] {"Ǝ", "E"},
