...
";
        ...
        /// </summary>
        public static readonly Regex MaintenanceTemplates = Tools.NestedTemplateRegex(new[] { "orphan", "BLP unsourced", "cleanup", "underlinked", "dead end", "notability", "refimprove" }, false );
