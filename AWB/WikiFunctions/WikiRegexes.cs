...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        public static readonly Regex UnitsWithoutNonBreakingSpaces = new Regex(@"(\b\d?\.?\d+)\s*((?:[cmknuµ])(?:[mgWN])|m?mol|cd|mi|lb[fs]?|b?hp|mph|ft|[kGM]?Hz|m/s|°[CF])\b(?<!(\d?\.?\d+)mm)");
...
";
        ...
        /// </summary>
        public static readonly Regex IbidOpCitation = new Regex(@"\b(ibid|op.{1,4}cit|loc.{1,4}cit)\b", RegexOptions.IgnoreCase | RegexOptions.Singleline);
