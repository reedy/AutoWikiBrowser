...
namespace WikiFunctions.Parse
{
    ...
    class MetaDataSorter
    {
        ...
        readonly string[] InterwikiLocalAlpha = new string[] { "aa", "af", "ak", "als", "am", "ang", "ab", "ar", "an", "roa-rup", "frp", "as", "ast", "gn", "av", "ay", "az", "bm", "bn", "zh-min-nan", "map-bms", "ba", "be", "be-x-old", "bh", "bi", "bar", "bo", "bs", "br", "bg", "bxr", "ca", "cv", "ceb", "cs", "ch", "cbk-zam", "ny", "sn", "tum", "cho", "co", "za", "cy", "da", "pdc", "de", "dv", "arc", "nv", "dz", "mh", "et", "el", "eml", "en", "es", "eo", "eu", "ee", "fa", "fo", "fr", "fy", "ff", "fur", "ga", "gv", "gd", "gl", "ki", "glk", "gu", "got", "zh-classical", "xal", "ko", "ha", "haw", "hy", "hi", "ho", "hsb", "hr", "io", "ig", "ilo", "bpy", "id", "ia", "ie", "iu", "ik", "os", "xh", "zu", "is", "it", "he", "jv", "kl", "kn", "kr", "ka", "ks", "csb", "kk", "kw", "rw", "ky", "rn", "sw", "kv", "kg", "ht", "kj", "ku", "lad", "lbe", "lo", "la", "lv", "lb", "lt", "lij", "li", "ln", "jbo", "lg", "lmo", "hu", "mk", "mg", "ml", "mt", "mi", "mr", "mzn", "ms", "cdo", "mo", "mn", "mus", "my", "nah", "na", "fj", "nl", "nds-nl", "cr", "ne", "new", "ja", "nap", "ce", "pih", "no", "nn", "nrm", "nov", "oc", "or", "om", "ng", "hz", "ug", "pa", "pi", "pam", "pag", "pap", "ps", "km", "pms", "nds", "pl", "pt", "ty", "ksh", "ro", "rmy", "rm", "qu", "ru", "war", "se", "sm", "sa", "sg", "sc", "sco", "st", "tn", "sq", "ru-sib", "scn", "si", "simple", "sd", "ss", "sk", "cu", "sl", "so", "sr", "sh", "su", "fi", "sv", "tl", "ta", "roa-tara", "tt", "te", "tet", "th", "vi", "ti", "tg", "tpi", "to", "chr", "chy", "ve", "tr", "tk", "tw", "udm", "bug", "uk", "ur", "uz", "vec", "vo", "fiu-vro", "wa", "vls", "wo", "wuu", "ts", "ii", "yi", "yo", "zh-yue", "diq", "zea", "bat-smg", "zh", "zh-tw", "zh-cn" };
