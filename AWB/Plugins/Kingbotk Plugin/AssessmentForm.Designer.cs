...
namespace AutoWikiBrowser.Plugins.Kingbotk.ManualAssessments
{
	partial class AssessmentForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.ToolTip1.SetToolTip(this.ImportanceCheckedListBox, "Article importance/priority. Note: If you\'re tagging the talk page for more than " +
						"one WikiProject and the importance levels differ you\'ll have to tweak it manuall" +
						"y.");
			// 
			// Label1
			// 
