Friend NotInheritable Class AustraliaSettings
    ...
    WriteOnly Property StubClassModeAllowed() As Boolean Implements GenericSettingsClass.StubClassModeAllowed
        ...
        End Set
    End Property
    Friend Property AutoStub() As Boolean Implements GenericSettingsClass.AutoStub
        Get
    ...
    Private Sub LinkClicked(ByVal sender As Object, ByVal e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        System.Diagnostics.Process.Start("http://en.wikipedia.org/wiki/Template:WP_Australia")
    End Sub
