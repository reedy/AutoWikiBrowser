...
namespace AutoWikiBrowser.Plugins.Kingbotk.Plugins
{
	...
	partial class GenericTemplateSettings : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.TipLabel.Text = "Tip: The plugin also adds parameter insertion options" + Microsoft.VisualBasic.Strings.ChrW(13) + Microsoft.VisualBasic.Strings.ChrW(10) + "to the context menu of the" + " edit box. Just right" + Microsoft.VisualBasic.Strings.ChrW(13) + Microsoft.VisualBasic.Strings.ChrW(10) + "click inside the edit box to access them.";
