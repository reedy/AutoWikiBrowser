Namespace Logging
    ...
    Public Interface IMyTraceListener
        ...
        Sub WriteLine(ByVal Line As String)
        ...
        Sub WriteComment(ByVal Line As String)
        Sub WriteCommentAndNewLine(ByVal Line As String)
        ''' <summary>
        ''' Is this trace listener an upload client?
        ''' </summary>
        ''' <returns><b>True</b> if the trace listener can upload to Wikipedia</returns>
        ReadOnly Property Uploadable() As Boolean
    End Interface
