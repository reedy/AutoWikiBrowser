...
"));
        ...
        public void ArticleIssuesTemplatesTests()
        {
            ...
            Assert.IsTrue(WikiRegexes.ArticleIssuesTemplates.IsMatch(@"{{lead missing|date =  April 2009}}"));
            ...
            Assert.IsTrue(WikiRegexes.ArticleIssuesTemplates.IsMatch(@"{{one source|date =  April 2009}}"));
