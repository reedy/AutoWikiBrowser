...
namespace AutoWikiBrowser
{
    ...
    /// </summary>
    public partial class PluginLogging : UserControl
    {
        ...
        public PluginLogging(MyTrace pMyTrace, TextBox CategoryTextBox)
        {
            mStartingUp = true;
            MyTrace = pMyTrace;
        ...
        internal sealed class Props : UploadableLogSettings2
        {
            ...
            internal new bool Equals(Props Compare)
            {
                if (Compare.LogBadPages == LogBadPages && Compare.LogFolder == LogFolder && Compare.LogVerbose == LogVerbose && Compare.LogWiki == LogWiki && Compare.LogXHTML == LogXHTML && Compare.UploadAddToWatchlist == UploadAddToWatchlist && Compare.UploadJobName == UploadJobName && Compare.UploadLocation == UploadLocation && Compare.UploadMaxLines == UploadMaxLines && Compare.UploadOpenInBrowser == UploadOpenInBrowser && Compare.UploadToWikiProjects == UploadToWikiProjects && Compare.UploadYN == UploadYN && Compare.Category == Category)
                    return true;
                else
                    return false;
            }
