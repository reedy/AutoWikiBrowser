...
namespace AutoWikiBrowser
{
    partial class MyPreferences
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.chkLowPriority.CheckedChanged += new System.EventHandler(this.ChkLowPriorityCheckedChanged);
        	// 
        	// chkBeep
        	// 
        	...
        	this.chkEnableLogging.CheckedChanged += new System.EventHandler(this.ChkEnableLoggingCheckedChanged);
        	// 
        	// chkDiffInBotMode
        	// 
