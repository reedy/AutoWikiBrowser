...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        /// </summary>
        public static readonly Regex Dablinks = new Regex(@"{{\s*(?:For2?|[Dd]ablink|[Dd]istinguish2?|[Oo]therpeople[1-4]|[Oo]therpersons|[Oo]therplaces[23]?|[Oo]theruses-number|[Oo]theruses[1-4]?|[Rr]edirect-acronym|[Rr]edirect[2-4]?|[Dd]n|[Aa]mbiguous link|[Dd]isambig-acronym)\s*(?:\|[^{}]*(?:{{[^{}]*}}[^{}]*)?)?}}", RegexOptions.Compiled);
        #endregion
