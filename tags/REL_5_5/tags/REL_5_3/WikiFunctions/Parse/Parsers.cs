...
namespace WikiFunctions.Parse
{
    ...
    public class Parsers
    {
        ...
        static Parsers()
        {
            ...
            RegexUnicode.Add(new Regex("&#(x12[A-Za-z0-9]{3}|65536);", RegexOptions.Compiled), "&amp;#$1;");
        ...
        // fix incorrect <br> of <br.>, <\br>, <br\> and <br./>
        private static readonly Regex IncorrectBr = new Regex(@"< *br\. *>|<\\ *br *>|< *br *\\ *>|< *br\. */>", RegexOptions.IgnoreCase | RegexOptions.Compiled);
        ...
        private static string TagUpdaterME(Match m)
        {
            ...
            else
            {
                ...
                if(!dateFieldValue.Contains(@"{{subst:CURRENTMONTHNAME}} {{subst:CURRENTYEAR}}") && !dateFieldValue.Equals(Tools.TurnFirstToUpper(dateFieldValue.ToLower())))
