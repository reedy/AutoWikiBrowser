...
namespace UnitTests
{
    ...
    public class FixSyntaxTests : RequiresParser
    {
        ...
        public void FixISBNFormat()
        {
            ...
            Assert.AreEqual(@"ISBN 1245781549", Parsers.FixSyntax(@"ISBN 	1245781549"), "ISBN with space and tab");
            ...
            Assert.AreEqual(@"ISBN-13 9781245781549", Parsers.FixSyntax(@"ISBN–13 9781245781549"), "Fix ISBN–13 endash to dash");
            Assert.AreEqual(@"ISBN-10 12345781549", Parsers.FixSyntax(@"ISBN–10 12345781549"), "Fix ISBN–10 endash to dash");
            ...
            Assert.AreEqual(@"ISBN 978-92-0-103709-1", Parsers.FixSyntax(@"ISBN 978–92–0–103709–1"), "endash to hyphen within ISBN");
            Assert.AreEqual(@"ISBN 978-92-0-103709-X", Parsers.FixSyntax(@"ISBN 978–92–0–103709–X"), "endash to hyphen within ISBN");
            ...
            Assert.AreEqual(@"ISBN 9780881925166", Parsers.FixSyntax(@"[[ISBN]] [[Special:BookSources/9780881925166|<bdi>9780881925166</bdi>]]"), "ISBNT substed bdi tags");
            ...
            Assert.AreEqual(@"ISBN 9780881925166", Parsers.FixSyntax(@"[[International Standard Book Number|ISBN]] [[Special:BookSources/9780881925166|<bdi>9780881925166</bdi>]]"), "ISBNT substed bdi tags");
            ...
            Assert.AreEqual(@"[http://www.site.com info] ISBN 9789201037091", Parsers.FixSyntax(@"[http://www.site.com info; ISBN 9789201037091]"), "ISBN out of end of http external link, semicolon");
            Assert.AreEqual(@"[http://www.site.com info] ISBN 978920103709X ISBN 9789201037091", Parsers.FixSyntax(@"[http://www.site.com info ISBN 978920103709X ISBN 9789201037091]"), "ISBN out of end of http external link, 2x");

            const string nochange = @"[http://www.site.com ISBN 978-92-0-103709-X]";
            Assert.AreEqual(nochange, Parsers.FixSyntax(nochange), "No change to ISBN at end of external link when no other link text");
        ...
        public void FixPMIDFormat()
        {
            ...
            Assert.AreEqual(@"[[PMID:1245781549]]", Parsers.FixSyntax(@"[[PMID:1245781549]]"), "No change if alrady correct - magic link");
...
* List 2"));
        ...
        public void FixSyntaxExternalLinks()
        {
            ...
            Assert.AreEqual("[http://test.com]", Parsers.FixSyntax("[http:// http://test.com]"), "double http");
            Assert.AreEqual("[http://www.test.com]", Parsers.FixSyntax("[http:// www.test.com]"), "http www spacing");
            Assert.AreEqual("[https://www.test.com]", Parsers.FixSyntax("[https:// www.test.com]"), "https www spacing");
            Assert.AreEqual("[http://www.test.com]", Parsers.FixSyntax("[http%3A//www.test.com]"), "http colon encoding");
            Assert.AreEqual("[https://www.test.com]", Parsers.FixSyntax("[https%3A//www.test.com]"), "https colon encoding");
...
{{DEFAULTSORT:Orbe, Georgy}}";
        ...
        public void TestFixObsoleteBrAttributes()
        {
            ...
            Assert.AreEqual("{{clear}}", Parsers.FixSyntax(@"<br style=""clear:both;"" clear=""all"" />"));
            Assert.AreEqual("{{clear|left}}", Parsers.FixSyntax(@"<br style=""clear:left;"" clear=""all"" />"));
            Assert.AreEqual("{{clear|right}}", Parsers.FixSyntax(@"<br style=""clear:right;"" clear=""all"" />"));
