...
"));
        ...
        public void ArticleIssuesTests()
        {
            ...
            Assert.IsTrue(WikiRegexes.MultipleIssues.IsMatch(@"{{Multipleissues|wikify=May 2008|a=b|c=d}}"));
            Assert.IsTrue(WikiRegexes.MultipleIssues.IsMatch(@"{{multipleissues|wikify=May 2008|a=b|c=d}}"));
            Assert.IsTrue(WikiRegexes.MultipleIssues.IsMatch(@"{{Multiple issues|wikify=May 2008|a=b|c=d}}"));
            Assert.IsTrue(WikiRegexes.MultipleIssues.IsMatch(@"{{Multiple issues | wikify=May 2008|a=b|c=d}}"));
           ...
           | wikify=May 2008|a=b|c=d}}"));
            ...
            Assert.IsFalse(WikiRegexes.MultipleIssues.IsMatch(@"{{Articleissues }}"));
            Assert.IsFalse(WikiRegexes.MultipleIssues.IsMatch(@"{{Article issues }}"));
        }
        ...
        public void ArticleIssuesTemplatesTests()
        {
            ...
            Assert.IsTrue(WikiRegexes.MultipleIssuesTemplates.IsMatch(@"{{cite check|date=April 2009}}"));
            ...
            Assert.IsTrue(WikiRegexes.MultipleIssuesTemplates.IsMatch(@"{{cleanup-link rot|date =  April 2009}}"));
        ...
        public void DeathsOrLivingCategoryTests()
        {
            ...
            Assert.IsTrue(WikiRegexes.DeathsOrLivingCategory.IsMatch(@"[[Category:Year of death uncertain]]"));
            Assert.IsTrue(WikiRegexes.DeathsOrLivingCategory.IsMatch(@"[[Category:839 deaths ]]"));
