...
"));
        ...
        public void ArticleIssuesTemplatesTests()
        {
            ...
            Assert.IsTrue(WikiRegexes.MultipleIssuesTemplates.IsMatch(@"{{news release|date =  April 2009}}"));            Assert.IsTrue(WikiRegexes.MultipleIssuesTemplates.IsMatch(@"{{newsrelease|date =  April 2009}}"));
