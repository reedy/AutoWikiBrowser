...
/>";
            ...
            Assert.AreEqual(grouped4, Parsers.FixReferenceTags(grouped4), "No change to valid group ref, slash");
            ...
            Assert.AreEqual(@"now <ref name =""foo bar"">and", Parsers.FixReferenceTags(@"now <ref name +""foo bar>and"), "Plus and missing ending quote");
            Assert.AreEqual(@"now <ref name =""foo bar"">and", Parsers.FixReferenceTags(@"now <ref name +foo bar"">and"), "Plus and missing opening quote");
            ...
            Assert.AreEqual(@"<ref name =""Fred"" />", Parsers.FixReferenceTags(@"<ref NAME =""Fred"" />"), "ref NAME");
            Assert.AreEqual(@"<ref name =""Fred"" />", Parsers.FixReferenceTags(@"<ref name = name =""Fred"" />"), "ref name=name=");
            Assert.AreEqual(@"<ref name =""Fred"" />", Parsers.FixReferenceTags(@"<ref name=name =""Fred"" />"), "ref name=name=");
            Assert.AreEqual(@"<ref name=""Fred""/>", Parsers.FixReferenceTags(@"<ref name=""ref name=""Fred""/>"), @"ref name=""ref name=""");
            Assert.AreEqual(@"<ref name = ""Fred""/>", Parsers.FixReferenceTags(@"<ref name = "" ref name = ""Fred""/>"), @"ref name=""ref name=""");
...
<ref name=""Lewis"">{{cite journal |authors=Lewis JT |title=Low-grade cases |journal=Am J Surg Pathol |pmid=22301502}}</ref>", Parsers.DuplicateNamedReferences(Lewis), "When dupe cite to condense, and another one after reflist, don't condense both");
        ...
        public void DeriveReferenceNameTests()
        {
            ...
            Assert.AreEqual("Hypnotist The Incredible BORIS is B", Parsers.DeriveReferenceName("a", @"{{cite web | url=hello.imdb.com/tt0120992/ | title=Hypnotist The Incredible BORIS is Boris Cherniak | accessdate=2007-10-15 }}"));
            Assert.AreEqual("Hypnotist The Incredible BORIS", Parsers.DeriveReferenceName("a", @"{{cite web | url=hello.imdb.com/tt0120992/ | trans-title= |title=Hypnotist The Incredible BORIS | accessdate=2007-10-15 }}"), "title use");
            Assert.AreEqual("Hypnotist The Incredible BORIS", Parsers.DeriveReferenceName("a", @"{{cite web | url=hello.imdb.com/tt0120992/ | title=Foreign language|trans-title=Hypnotist The Incredible BORIS | accessdate=2007-10-15 }}"), "Trans-title use");
            Assert.AreEqual("Hypnotist The Incredible BORIS is B", Parsers.DeriveReferenceName(@"A<ref name=""hello.imdb.com"">x</ref>", @"{{cite web | url=https://hello.imdb.com/tt0120992/ | title=Hypnotist The Incredible BORIS is Boris Cherniak | accessdate=2007-10-15 }}"));
  ...
  | archivedate = 2008-11-01}}"));
            ...
            Assert.AreEqual("ReferenceD", Parsers.DeriveReferenceName("a<ref name=ReferenceA>foo</ref> now <ref name=ReferenceB>foo</ref> <ref name=ReferenceC>foo</ref>", @"* Cf. Ezriel Carlebach entry in the Hebrew Wikipedia"));
...
|author-given=, |author-surname=, |display-subjects=, |interviewer-given=, |interviewer-surname=, |orig-date=, |quote-page=, |quote-pages=, |sbn=, |script-quote=, |subject-mask=, |s2cid=, |s2cid-access=, |title-link=, |trans-quote= , |translator1=,}}"));
